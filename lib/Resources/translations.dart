    ...
    return {
      'en': {
        ...
        AT1Strings.customersTitleDesc:
            'This page shows the number of successful conversions generated by your link',
        AT1Strings.agentCopy: 'Click at link to copy',
        AT1Strings.agentLink: 'Referral Link',
      ...
      'ar': {
        ...
        AT1Strings.customersTitleDesc:
            'هذه الصفحة تظهر عدد الإحالات الناجحة التى تمت عن طريق الرابط الخاص بك',
        AT1Strings.agentCopy: 'انقر على الرابط للنسخ',
        AT1Strings.agentLink: 'رابط الإحالة',
        AT1Strings.textcopied: 'تم نسخ النص',
      },
      'tr': {
        ...
        AT1Strings.customersTitleDesc:
            'Bu sayfa, bağlantınız tarafından oluşturulan başarılı dönüşümlerin sayısını gösterir',
        AT1Strings.agentCopy: 'Kopyalamak için bağlantıya tıklayın',
        AT1Strings.agentLink: 'Yönlendirme Bağlantısı',
        AT1Strings.textcopied: 'Metin kopyalandı',
      },
      'fr': {
        ...
        AT1Strings.customersTitleDesc:
            "Cette page affiche le nombre de conversions réussies générées par votre lien.",
        AT1Strings.agentCopy: 'Cliquez sur le lien pour copier',
        AT1Strings.agentLink: 'Lien de recommandation',
        AT1Strings.textcopied: 'Texte copié',
      },
    };
  }
}
