...
appRoutes() => [
  ...
  GetPage(name: CheckMailScreen.routeName, page: () => CheckMailScreen(),),
  //User
  ...
  //Services
  GetPage(name: ServiceSingleScreen.routeName, page: () => ServiceSingleScreen(),),
  GetPage(name: ServiceRequestScreen.routeName, page: () => ServiceRequestScreen(),),
  GetPage(name: ServiceRequestSentScreen.routeName, page: () => ServiceRequestSentScreen(),),
  //Notifications
  GetPage(name: NotificationsScreen.routeName, page: () => NotificationsScreen(),),
  //Contact us
  GetPage(name: ContactUsScreen.routeName, page: () => ContactUsScreen(),),
  //Shared
  GetPage(name: IntroScreen.routeName, page: () => IntroScreen(),),
  GetPage(name: AboutAppScreen.routeName, page: () => AboutAppScreen(),),
  GetPage(name: HelpCenterScreen.routeName, page: () => HelpCenterScreen(),),
  GetPage(name: SettingScreen.routeName, page: () => SettingScreen(),),
  GetPage(name: ContentScreen.routeName, page: () => ContentScreen(),),
];